...
project = 'YouTube TV Start Guide'
copyright = '2025, YouTube'
author = 'YouTube Support Team'
...
# Basic page info
html_title = "How to Start YouTube TV Using tv.youtube.com/start"
html_short_title = "YouTube TV Start Guide"
